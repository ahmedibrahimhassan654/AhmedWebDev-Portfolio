        ...
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <p className="home-about-body">
              ...
              in building{" "}
              <span className="purple"> MERN Stack Web Developmet </span>
              <br />
              <br />i have experience in modern web tehnologies
              <i>
                <b className="purple">
                  {" "}
                  Advance knowledge in HTML, CSS, and JS with experience in
                  building react js app .{" "}
                </b>
                <b className="purple">
                  {" "}
                  Building Server side with node js , mongo db, express Js{" "}
                </b>
              </i>
              <br />
              <br />
              ...
              <i>
                <b className="purple">
                  building server side with node js , mongo db,prisma, express Js{" "}
                </b>
              </i>
              <br />
              <br />
